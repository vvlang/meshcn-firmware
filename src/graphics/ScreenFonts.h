...
#else
#ifdef OLED_CN
#define FONT_SMALL_LOCAL ArialMT_Plain_10_CN // Height: 13
#else
...
#else
#ifdef OLED_CN
#define FONT_MEDIUM_LOCAL ArialMT_Plain_16_CN // Height: 19
#else
...
#else
#ifdef OLED_CN
#define FONT_LARGE_LOCAL ArialMT_Plain_24_CN // Height: 28
#else
